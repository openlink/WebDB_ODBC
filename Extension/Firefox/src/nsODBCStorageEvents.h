...
#ifndef _nsODBCStorageEvents_h_
#define _nsODBCStorageEvents_h_
...
class nsIODBCStorageStatement;
class nsIODBCStorageStatementCallback;
class nsIODBCStoragePendingStatement;
...
nsresult NS_executeAsync(
  nsCOMArray<nsIODBCStorageStatement> &aStatements,
